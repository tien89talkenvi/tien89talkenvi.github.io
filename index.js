...
function chon_vkhacf() {
  ...
  if (y[x].text=="2. Let's learn Englist on VOA") {
    let result = "https://cahoan.github.io";
    document.getElementById("demo_viec_chon").href = result;
    document.getElementById("demo_viec_chon").click();
  }  
  if (y[x].text=="3. Giáo lý Công giáo cho người dự tòng") {
    let result = "https://tienapc.github.io";
    document.getElementById("demo_viec_chon").href = result;
    document.getElementById("demo_viec_chon").click();

  }
  if (y[x].text=="4. Learning English with Streamlines") {
    let result = "https://huaanshoang.github.io";
    document.getElementById("demo_viec_chon").href = result;
    document.getElementById("demo_viec_chon").click();

  }
  if (y[x].text=="5. Learning English on Tran Cao Boi's book") {
